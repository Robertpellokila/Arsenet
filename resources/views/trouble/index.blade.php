<x-app-layout>
    ...
    <div class="container mx-auto p-6 mt-12">
        ...
        <h2 class="text-2xl text-center font-semibold text-gray-800 dark:text-white mb-10">
            Laporan Trouble Saya
        </h2>
         <!-- Tambahkan tombol tambah laporan -->
         <a href="{{ route('trouble.create') }}"
         class="px-4 py-2 mb-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-400 shadow-lg outline-2">
         + Buat Laporan Trouble
     </a>
            ...
            <table class="w-full mt-4 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <span class="@if ($trouble->status === 'canceled') text-red-500 rounded-md bg-red-100 p-1
             @elseif ($trouble->status === 'completed') text-green-500 rounded-md bg-green-100 p-1  
             @else text-yellow-500 rounded-md bg-yellow-100 p-1  @endif">
                        ...
                        <td class="px-6 py-4">
                            {{ $trouble->created_at->format('F Y') }}
                        </td>
                        <td class="px-6 py-4">
                            <img src={{ asset('/storage/' . $trouble->foto) }} alt="" class="w-20 h-20">
                        </td>
                        <td class="flex px-6 py-4 space-x-2 justify-center">
                            <a href="{{ route('trouble.show', $trouble->id) }}"
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-4 text-center text-xl dark:text-white">
                            Anda belum memiliki laporan trouble.
                        </td>
                    </tr>
                    @endforelse
